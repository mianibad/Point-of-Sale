...
namespace PointOfSale
{
    public partial class ProductManagement : Form
    {
        ...
        private void ProductManagement_Load(object sender, EventArgs e)
        {
            ...
            var myControls = new ucMainProductManagement();
        ...
        private void pBMenu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblMenuHead.Show();
                btnAllItemsList.Text = "All Items List";
        ...
        private void btnProdCategory_Click(object sender, EventArgs e)
        {
            label2.Hide();

            panelUCContainer.Controls.Clear();
            panelUCContainer.Show();
            var myControls = new ucMainProductCategory();
            myControls.Dock = DockStyle.Fill;
            panelUCContainer.Controls.Add(myControls);
            hideMenu();
        }
